...
export default function experimental_login() {
    ...
    const auth = () => {
        ...
        const pwd = document.getElementById("pwd").innerText
                ...
                <View style={styles.bodyBox}>
                    <View style={styles.mainLoginBox}>
                        ...
                        <View style={styles.emailBox}>
                            <TextInput id="id" style={styles.inputEmail} placeholder={'sample_email@email.com'} />
                        ...
                        <View style={styles.passwordBox}>
                            <TextInput id="pwd" secureTextEntry={true} style={styles.inputPassword} placeholderTextColor={'gray'} placeholder={'Input Your Password Here!'}></TextInput>
                        ...
                        <TouchableOpacity style={styles.submitButton} underlayColor="#000" onPress={auth}>

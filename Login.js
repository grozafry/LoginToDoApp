...
import { Text, View, TextInput, Platform, Image, KeyboardAvoidingView, Dimensions, TouchableOpacity,SafeAreaView, TouchableHighlight, StyleSheet, AsyncStorage } from 'react-native';
...
/* Password Verification */
    function login_attempt() {
        // alert(userid)
        if (Users[useridEntered] === passwordEntered ) {            
            setGoHome(true);
        } else {    
            alert('Nope!');
        }

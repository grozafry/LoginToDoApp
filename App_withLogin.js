...
export default function UserLogin() {
    ...
    */
    ...
    async function sign_up() {
        ...
        // setGoHome(true);
           await firebase.auth()
                .createUserWithEmailAndPassword(useridEntered, passwordEntered);
...
/* Password Verification */
    function login_attempt() {
        ...
        // console.log(Users["Ashu"].pwd)
        
        if (passwordEntered==Users["Ashu"].pwd) {            
            setGoHome(true);
        } else {    
            alert('Nope!');
        }
    ...
    async function login() {
        ...
        try {
            await firebase.auth()
                .signInWithEmailAndPassword(useridEntered, passwordEntered);
    ...
    return (
        ...
        <KeyboardAvoidingView style={styles.mainbox} behavior={Platform.OS == "ios" ? "padding" : "height"}>
            ...
            {/*Button to go back to unsigned home screen []*/}
                <TouchableHighlight activeOpacity={1} underlayColor="#0070bb" style={styles.backnavigation} onPress={sign_up}>
            ...
            {/*Button to submit password [login_attempt] (shares the visibility criteria same as password box)*/}
                    <View style={{display:passBoxVisibility}}>
                        <TouchableOpacity style={styles.submitbutton} underlayColor="#000" onPress={login}>
            ...
            {/*Button for signing up if the user is not registered and is interested []*/}
                    <View style={styles.signupbox}>
                        ...
                        <TouchableOpacity style={styles.signupbutton} onPress={sign_up}> 
